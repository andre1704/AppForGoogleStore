package com.sdacademy.slowinski.andrzej.appforgooglestore;
...
import com.sdacademy.slowinski.andrzej.appforgooglestore.adapters.MyPageAdapter;
import com.sdacademy.slowinski.andrzej.appforgooglestore.fragments.BatteryFragment;
import com.sdacademy.slowinski.andrzej.appforgooglestore.fragments.FlashlightFragment;
import com.sdacademy.slowinski.andrzej.appforgooglestore.fragments.StopwatchFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void addFragments() {
        ...
        tabLayout.getTabAt(TAB_FLASHLIGHT_POSITION)
                .setIcon(getDrawable(R.drawable.ic_wb_incandescent_black_24dp));
        tabLayout.getTabAt(TAB_STOPWATCH_POSITION)
                .setIcon(getDrawable(R.drawable.ic_timer_black_24dp));
    }
}
